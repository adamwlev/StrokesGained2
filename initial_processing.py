...
def doit(year):
	...
	data['start_loc_equal_to_prev_end_loc'] = [tuple(tup) in start_loc_equal_to_prev_start_loc 
	...
	locs = {tuple(tup[:-1]):tup[-1] for tup in data[id_cols + ['Real_Shots','End_loc']].values}
	start_loc = []
