...
def doit(year):
    ...
    data['start_loc_equal_to_prev_end_loc'] = 0
    ...
    data.loc[data.start_loc_equal_to_prev_start_loc,'Start_X_Coordinate'] = [start_locs[tuple(tup)][0] 
                                                                             for tup in data.loc[data.start_loc_equal_to_prev_start_loc,id_cols+['Real_Shots']].values]
    data.loc[data.start_loc_equal_to_prev_start_loc,'Start_Y_Coordinate'] = [start_locs[tuple(tup)][1] 
                                                                             for tup in data.loc[data.start_loc_equal_to_prev_start_loc,id_cols+['Real_Shots']].values]
    data.loc[data.start_loc_equal_to_prev_start_loc,'Start_Z_Coordinate'] = [start_locs[tuple(tup)][2] 
                                                                             for tup in data.loc[data.start_loc_equal_to_prev_start_loc,id_cols+['Real_Shots']].values]
